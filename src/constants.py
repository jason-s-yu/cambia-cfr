...
class ActionSnapOpponent(NamedTuple):
     ...
     opponent_target_hand_index: int # Which of *opponent's* cards to snap (must match rank) ### CLARIFIED ###
...
GameAction = Union[ ActionDrawStockpile, ActionDrawDiscard, ActionCallCambia,
                   ActionDiscard, ActionReplace,
                   ActionAbilityPeekOwnSelect, ActionAbilityPeekOtherSelect,
                   ActionAbilityBlindSwapSelect, ActionAbilityKingLookSelect,
                   ActionAbilityKingSwapDecision,
                   ActionPassSnap, ActionSnapOwn, ActionSnapOpponent, ActionSnapOpponentMove # Updated Union
                  ]